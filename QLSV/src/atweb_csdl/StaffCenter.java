            ...
            if(stateEdit == true){                                
                ...
                if(check == true){                                                                                    
                    ...
                    query = "EXEC SP_ADMIN_EDIT_NHANVIEN_USN '" +
                        txtStaffCode.getText() + "','" + salary + "','" + txtUsn.getText() + "'";              //+ "','" + txtName.getText() + "','" + txtEmail.getText() + "','" + "','" + txtUsn.getText() + "','" + new Services().getSHAHash(txtPass.getText(), "SHA1") + 
                    try{
            ...
            if(stateInsert == true){
                ...
                if(checkStaffCode == false && checkUsn == false){
                    ...
                    query = "EXEC SP_INS_PUBLIC_ENCRYPT_NHANVIEN '" +
                                    ...
                                    rsa.encrypt(txtSalary.getText()) + "','" + txtUsn.getText() + "','" + new Services().getSHAHash(txtPass.getText(), "SHA1") + "','" + path + "'" ;
                    try{
                        ps = cn.prepareStatement(query);
                        rs = ps.executeQuery();            
                    }catch(SQLException e){
