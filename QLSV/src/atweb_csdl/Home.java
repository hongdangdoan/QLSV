...
//        txtNewMalop.setText(get);
    ...
    public Home(String tenNV,String matKhau) {
        initComponents();
        Home.tenNV = tenNV;
        Home.matKhauNV = matKhau;    System.out.println(matKhau);         
            ...
            .addGroup(jpnSearchSvLayout.createSequentialGroup()
                .addGroup(jpnSearchSvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpnSearchSvLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jpnSearchSvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jButton_xemDiem, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE)
                            .addGroup(jpnSearchSvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jpnQldiemLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpnQldiemLayout.createSequentialGroup()
                .addGroup(jpnQldiemLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jpnSearchDiem, javax.swing.GroupLayout.DEFAULT_SIZE, 774, Short.MAX_VALUE)
 ...
 String maLop = txtNewMalopSv.getText();//System.out.println(maLop);
        String masv = txtNewMasv.getText();
        String hoTen = txtNewName.getText();
        String diaChi = txtNewAddress.getText();
        Date  ngaySinh = jdcNewBirth.getDate();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        String ngaySinhStr = dateFormat.format(ngaySinh);System.out.println(ngaySinh);

        String tenDN = txtNewUsn.getText();
        String matKhau = txtNewPass.getText();
         String sql = null;
        if(addSv){System.out.println("Them moi sinh vien");
            initTextFeld();
    ...
    private void SaveNewDiemMouseClick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaveNewDiemMouseClick
        ...
        String tenHP = cbxDsHocphan.getSelectedItem().toString();System.out.println(tenHP);
        String maHp = getMaMHP(tenHP);
...
//        showDiemList(s);
    ...
    private void jtbEditDiemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbEditDiemMouseClicked
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel)jTableDiem.getModel();
        String s = (String) model.getValueAt(jTableDiem.getSelectedRow(), 0);
        String diem =String.valueOf( model.getValueAt(jTableDiem.getSelectedRow(), 2));
        String sql = "EXEC SP_UPDATE_PUBLIC_ENCRYPT_BANGDIEM '"+s+"','"+this.maSVHienTai
                +"','"+new RSAGenerator(this.tenNV, this.matKhauNV).encrypt(diem)+"'";
        System.out.println(sql);
        try {
            this.ps = cn.prepareStatement(sql);
            this.rs = ps.executeQuery();
    ...
    }//GEN-LAST:event_jtbEditDiemMouseClicked
     ...
     private void jtbEditSvMouseClicked(java.awt.event.MouseEvent evt) {                                       
       ...
       if(this.trueNV_Lop){
        ...
        txtNewMalopSv.disable();
         ...
         private void jtbDelSvMouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
        if(this.trueNV_Lop){
            ...
            try {
                ...
                DefaultTableModel model = (DefaultTableModel)jTableSv.getModel();
                String maSV = (String) model.getValueAt(jTableSv.getSelectedRow(), 0);
   ...
   public String getMaNVFromDatabase(String tenNV){
    ...
    public  void ktDungNV_Lop(String maNV,String MaLop){
        String sql = "SELECT MANV FROM LOP WHERE MALOP = '"+MaLop+"' "+
                "AND MANV='"+maNV+"'";
        ...
        try {
            ...
            if(rs.next()==false)this.trueNV_Lop = false;
            else{
                this.trueNV_Lop = true;
            }
        } catch (SQLException ex) {
            this.trueNV_Lop = false;
    ...
    public boolean ktTonTaiTenSVDN(String tenDN){
          String sql = "SELECT MASV FROM SINHVIEN WHERE TENDN = '"+tenDN+"'";
        try {
            ps = cn.prepareStatement(sql);
            rs = ps.executeQuery();
        } catch (SQLException ex) {
