...
//            Qlnv.setVisible(true);
            ...
            staffCenter.setVisible(true);
        }
        else {
        String query = "SELECT TENDN, MATKHAU FROM NHANVIEN WHERE TENDN = '" + 
                username + "' AND MATKHAU = '" + new Services().getSHAHash(password, "SHA-1") + "'";
        ...
        try{
            ...
            if(rs.next()){
                ...
                dispose();                
                Home classroom = new Home(username,password);
